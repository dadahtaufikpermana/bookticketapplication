...
class TicketView extends StatelessWidget {
  ...
  final bool? isColor;
  const TicketView({Key? key,required this.ticket, this.isColor}) : super(key:
  key);
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
                  ...
                  Row(
                    children: [
                      Text(
                        ticket['from']['code'],
                        style:
                        isColor==null?Styles.headLineStyle3.copyWith(color:
                        Colors
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        ticket['flying_time'],
                        style:
                        isColor==null?Styles.headLineStyle4.copyWith(color:
                        Colors
            ...
            */
            Container(
              color: isColor==null?Styles.orangeColor:Colors.white, //const Color
              // (0xfff37b67),
              child: Row(
                children: [
                  SizedBox(
                        ...
                        return Flex(
                          ...
                          children: List.generate(
                              (constraints.constrainWidth() / 15).floor(),
                                ...
                                child: DecoratedBox(
                                  decoration:
                                  BoxDecoration(color: isColor==
                                      null?Colors.white:Colors
                                      .grey.shade300),
                                ),
                              )),
                        );
